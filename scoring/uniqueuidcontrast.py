...
def evalscore(brandid, poi, totviscnt, bktdata, method = 'totuidnormed'):
    ...
    # filter out bad ones
    #filteredblkdata = [[x,y[0],y[1]] for x,y in bktdata.iteritems() if y[0]>1 and y[0] > 0.01*totviscnt and y[1]>20]
    filteredblkdata = [[x,y[0],y[1]] for x,y in bktdata.iteritems() if y[0]>1 and y[1]>20]
